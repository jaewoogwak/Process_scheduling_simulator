class SPN:
    ...
    def processData(self, no_of_processes, AT:list, BT:list):
        ...
        SPN.schedulingProcess(self, process_data)
    ...
    def schedulingProcess(self, process_data):
        ...
        t_time = SPN.calculateTurnaroundTime(self, process_data)
        w_time = SPN.calculateWaitingTime(self, process_data)
        SPN.printData(self, process_data, t_time, w_time)
